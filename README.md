# Wireless-IoT-Asset-Monitor

Industrial Wireless IoT Asset Monitor Sensor With 2 Mile Range can be found over

http://store.ncd.io/product/wireless-asset-monitor-sensor/
